...
const removeAdminDoctor = require('./routes/removeAdminDoctor')
const removeAdminPatient = require('./routes/removeAdminPatient')
...
app.use('/api/remove/admin/doctor', removeAdminDoctor) 
app.use('/api/remove/admin/patient', removeAdminPatient)
